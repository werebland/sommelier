...
var ActionButton = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].a.withConfig({
  displayName: "restaurant__ActionButton",
  componentId: "b9wkxk-1"
})(["position:fixed;top:16px;right:16px;height:40px;padding:0 24px;display:flex;align-items:center;justify-content:center;border-radius:4px;overflow:hidden;background:#FFFFFF;box-shadow:0 2px 16px -2px rgba(0,0,0,0.32);cursor:pointer;text-decoration:none;font-size:1rem;font-weight:400;color:#0f0f0f;"]);
...
function (_Component) {
  ...
  _createClass(Restaurant, [{
    ...
    value: function handleScroll() {
      console.log(window.current.scrollTop);
    }
  }, {
    key: "fetchDishes",
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(RestaurantWrapper, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(next_head__WEBPACK_IMPORTED_MODULE_2___default.a, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("title", null, "What to eat at ", this.props.restaurant.title, " - ", this.props.restaurant.address.street, ", ", this.props.restaurant.address.city), react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("link", {
        ...
        width: this.state.sticky ? "calc(100% - ".concat(this.actionButton.current.offsetWidth, " - 16px)") : '100%',
...
//# sourceMappingURL=restaurant.js.50b422d70cb5c4c67979.hot-update.js.map